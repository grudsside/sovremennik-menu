...
(function(root,factory){
  ...
  const ROLES=Object.freeze({
    ...
    barista:{label:'Бариста',icon:'☕',accent:'olive',routes:['home','tasks','method','theory','checklists','revisions','techcards','schedule','reportError'],home:['todayWork','openingChecklist','closingChecklist','coffeeRevision','personalTasks'],operations:['view_assigned','submit_checklist','submit_revision','view_coffee_revision','report_issue']},
    waiter:{label:'Официант',icon:'●',accent:'blue',routes:['home','tasks','method','theory','checklists','schedule','reportError'],home:['todayWork','openingChecklist','closingChecklist','personalTasks'],operations:['view_assigned','submit_checklist','report_issue']}
  });
