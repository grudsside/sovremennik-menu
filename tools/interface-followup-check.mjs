...
const [script, styles, mobileScript, mobileStyles, loader, workflow] = await Promise.all([
...
assert.match(loader, /mobile-tasks-performance\.css\?v=20260719-1/, 'Mobile task performance CSS must be cache-busted and loaded last');
