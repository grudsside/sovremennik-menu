...
const required = [
  ...
  [serviceWorker.includes("sovremennik-offline-20260725-v11"), 'PWA cache must be refreshed'],
  ...
  [photoRulesOpenFix.includes('if(!details.isConnected || card() !== details) return;'), 'detached toggle events must not overwrite the remembered state'],
