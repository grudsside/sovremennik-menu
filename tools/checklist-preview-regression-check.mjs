...
const required = [
  ...
  [push.includes('control-section-draft-key-bridge.js?v=20260725-3'), 'offline checklist key bridge v3 must be loaded'],
  ...
  [serviceWorker.includes("sovremennik-offline-20260725-v19"), 'PWA cache must be refreshed'],
