...
const required = [
  ...
  [push.includes('control-section-draft-key-bridge.js?v=20260725-1'), 'offline checklist key bridge must be loaded'],
  ...
  [serviceWorker.includes("sovremennik-offline-20260725-v17"), 'PWA cache must be refreshed'],
