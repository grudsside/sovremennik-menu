...
assert.ok(worker.includes("const CACHE_VERSION = 'sovremennik-offline-20260730-v28'"), 'Control v3 PWA cache is not active');
...
console.log('Checklist review tools and Control v3 structure are valid.');
