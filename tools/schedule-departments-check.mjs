...
assert.match(loader, /schedule-manager\.js[\s\S]*schedule-departments\.js\?v=20260720-2[\s\S]*interface-followup\.js/, 'Updated department layer must load after schedule manager');
