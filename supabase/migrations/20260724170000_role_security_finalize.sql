-- Finalize the role lifecycle after the first role preview migration.
-- This migration has a new timestamp so already-created preview databases
-- and future production releases both receive the latest server contract.
begin;
